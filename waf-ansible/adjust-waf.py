...
parser.add_argument("--Region", choices=["us-east-1","us-east-2"], help="Region of the WebACL")
...
parser.add_argument("--HttpFloodRateBasedRule", choices=["Block", "Count"], help="Action for HttpFloodRateBased rules")
